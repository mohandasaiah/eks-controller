...
// +kubebuilder:rbac:groups=eks.services.k8s.aws,resources=identityproviderconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eks.services.k8s.aws,resources=identityproviderconfigs/status,verbs=get;update;patch
