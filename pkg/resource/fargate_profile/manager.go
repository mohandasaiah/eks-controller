...
// +kubebuilder:rbac:groups=eks.services.k8s.aws,resources=fargateprofiles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eks.services.k8s.aws,resources=fargateprofiles/status,verbs=get;update;patch
