...
var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("podidentityassociations")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.PodIdentityAssociation{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.PodIdentityAssociation),
	}
}
