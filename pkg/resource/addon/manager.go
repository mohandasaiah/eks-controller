...
// +kubebuilder:rbac:groups=eks.services.k8s.aws,resources=addons,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eks.services.k8s.aws,resources=addons/status,verbs=get;update;patch
